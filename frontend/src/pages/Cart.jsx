        ...
        <div className="w-full lg:w-96 shrink-0">
          <div className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-sm sticky top-28">
            ...
            <div className="space-y-4 mb-6">
              ...
              {deliveryFee > 0 && (
                <p className="text-xs text-gray-500">Add ₹{500 - total} more for free delivery</p>
              )}
            </div>
            ...
            <div className="border-t border-gray-100 pt-4 mb-8">
              <div className="flex justify-between items-end">
                ...
                <span className="text-3xl font-black text-primary tracking-tight">₹{total + deliveryFee}</span>
              </div>
